...
const ReviewApplication = () => {
    ...
    // يُفتح من الـ modal وبيجيب السبب
                ...
                <div className="lg:col-span-4 space-y-6">
                    ...
                    <div className="bg-white border border-[#f1f5f9] rounded-[20px] sm:rounded-[24px] p-5 sm:p-6">
                        <h5 className="text-[15px] font-bold text-[#0f172a] mb-4">
                            Documents
                            <span className="ml-2 text-[12px] font-normal text-[#94a3b8]">({docs.length} uploaded)</span>
                        </h5>
                        {docs.length === 0 ? (
                            <p className="text-[13px] text-[#94a3b8] text-center py-4">No documents uploaded</p>
                        ) : (
                            <div className="space-y-2.5">
                                {docs.map((doc) => (
                                    <div key={doc.id} className="flex justify-between items-center p-3 border border-[#f1f5f9] rounded-[12px] hover:bg-[#f8fafc] transition-colors">
                                        <div className="flex items-center gap-3 min-w-0">
                                            <CircleCheckBig size={18} className="text-green-500 flex-shrink-0" />
                                            <div className="min-w-0">
